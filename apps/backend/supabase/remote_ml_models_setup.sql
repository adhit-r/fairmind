-- Create ML Models table and related enums for FairMind (Remote Database)
...
DO $$ BEGIN
    CREATE TYPE public."ModelType" AS ENUM ('classification', 'regression', 'clustering', 'nlp', 'llm', 'deep_learning', 'ensemble');
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
