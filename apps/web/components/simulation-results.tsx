...
import { Button, Card, CardContent, CardDescription, CardHeader, CardTitle, Tabs, TabsContent, TabsList, TabsTrigger, Badge, Progress, Alert, AlertDescription, AlertTitle } from "@fairmind/ui"
...
import { RobustnessChart } from "@/components/charts/robustness-chart"
import { PerformanceMatrix } from "@/components/charts/performance-matrix"
import { DistributionChart } from "@/components/charts/distribution-chart"

const fairnessData = [
  { group: "Age 18-25", score: 85, status: "good" },
  { group: "Age 26-35", score: 65, status: "warning" },
  { group: "Age 36-45", score: 82, status: "good" },
  { group: "Age 46-55", score: 78, status: "good" },
  { group: "Age 56+", score: 71, status: "warning" },
]

const robustnessMetrics = [
  { metric: "Noise Resilience", score: 92, change: "+5%" },
  { metric: "Data Drift Tolerance", score: 88, change: "-2%" },
  { metric: "Adversarial Robustness", score: 94, change: "+8%" },
  { metric: "Feature Importance Stability", score: 86, change: "+1%" },
]
