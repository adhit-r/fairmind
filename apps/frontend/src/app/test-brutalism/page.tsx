...
export default function TestBrutalismPage() {
  return (
    <Stack p="xl" gap="xl">
      <Title>Brutalism Design Test</Title>
      <Text>Testing the Fairmind Brutalist Professional design system implementation</Text>
