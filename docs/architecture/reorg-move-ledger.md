...
| 2026-03-12 | `apps/backend/scripts/check_all_databases.py` | `archive/repo-legacy/supabase-legacy/scripts/check_all_databases.py` | Supabase-specific operational utility archived post-Neon migration. |
